...
const Login = () => {
  ...
  return (
    <div>
      ...
      <div className="fixed">
        <img
          className="h-screen object-cover md:h-screen lg:h-auto"
          src={BACKGROUND_IMG}
          alt="background-img"
        />
      </div>
      <form
        ...
        className="w-96 md:w-96 xl:w-[27%] p-12 bg-black absolute my-36 mx-auto left-0 right-0 text-white rounded-lg bg-opacity-85"
      >
